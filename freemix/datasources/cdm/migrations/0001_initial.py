...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'CDMDataSource'
        db.create_table('cdm_cdmdatasource', (
            ...
            ('search_term', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('collection_name', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
        ))
        db.send_create_signal('cdm', ['CDMDataSource'])


    def backwards(self, orm):
        
        # Deleting model 'CDMDataSource'
        db.delete_table('cdm_cdmdatasource')
    ...
    models = {
        ...
        'cdm.cdmdatasource': {
            'Meta': {'object_name': 'CDMDataSource', '_ormbases': ['dataset.DataSource']},
            'collection_name': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
            'datasource_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['dataset.DataSource']", 'unique': 'True', 'primary_key': 'True'}),
            'search_term': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
