...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('file_filedatasource', (
            ...
            ('original_mime_type', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True)),
            ('mime_type_guess', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True)),
            ('mime_type_magic_guess', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True)),
            ('filename', self.gf('django.db.models.fields.CharField')(max_length=50)),
        ))
        db.send_create_signal('file', ['FileDataSource'])


    def backwards(self, orm):
        
        # Deleting model 'FileDataSource'
        db.delete_table('file_filedatasource')
