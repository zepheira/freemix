...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Freemix.dataset'
        db.add_column('freemixprofile_freemix', 'dataset', self.gf('django.db.models.fields.related.ForeignKey')(related_name='exhibits', null=True, to=orm['dataset.Dataset']), keep_default=False)

        # Changing field 'Freemix.json'
        db.alter_column('freemixprofile_freemix', 'json', self.gf('django.db.models.fields.TextField')())


    def backwards(self, orm):
        
        # Deleting field 'Freemix.dataset'
        db.delete_column('freemixprofile_freemix', 'dataset_id')

        # Changing field 'Freemix.json'
        db.alter_column('freemixprofile_freemix', 'json', self.gf('django_extensions.db.fields.json.JSONField')())
    ...
    models = {
        ...
        'freemixprofile.freemix': {
            ...
            'dataset': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'exhibits'", 'null': 'True', 'to': "orm['dataset.Dataset']"}),
            'description': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
