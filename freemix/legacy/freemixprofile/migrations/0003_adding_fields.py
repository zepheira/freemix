...
class Migration:
    ...
    def forwards(self, orm):
        ...
        db.add_column('freemixprofile_freemix', 'title', orm['freemixprofile.freemix:title'])

        # Adding field 'Freemix.theme'
        db.add_column('freemixprofile_freemix', 'theme', orm['freemixprofile.freemix:theme'])

        # Adding field 'Freemix.description'
        db.add_column('freemixprofile_freemix', 'description', orm['freemixprofile.freemix:description'])
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Freemix.theme'
        db.delete_column('freemixprofile_freemix', 'theme_id')

        # Deleting field 'Freemix.description'
        db.delete_column('freemixprofile_freemix', 'description')
