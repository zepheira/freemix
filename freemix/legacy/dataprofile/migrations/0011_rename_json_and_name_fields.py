...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'DataProfile.properties'
        db.add_column('dataprofile_dataprofile', 'properties', self.gf('django_extensions.db.fields.json.JSONField')(default='{}'), keep_default=False)

        # Adding field 'DataProfile.title'
        db.add_column('dataprofile_dataprofile', 'title', self.gf('django.db.models.fields.CharField')(default='title', max_length=255), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'DataProfile.properties'
        db.delete_column('dataprofile_dataprofile', 'properties')

        # Deleting field 'DataProfile.title'
        db.delete_column('dataprofile_dataprofile', 'title')
