...
(function($, Freemix) {
    ...
    function syncMetadata(model) {
        ...
        metadata.dataProfile = model.dataProfile;
    ...
    function display() {
        ...
        var database = $.exhibit.initializeDatabase(dataURLs, function() {
            $(".view-container", Freemix.getBuilder()).viewContainer();
            $.each(data.views, function(container, views) {
                $.each(views, function() {
                    var view = Freemix.view.createView(this);
            ...
            $.each(data.facets, function(container, facets) {
                $.each(facets, function() {
                    var facet = Freemix.facet.createFacet(this);
