...
{% block scripts %}
    ...
    "{%site_url STATIC_URL %}dataview/js/widget.js",
    "{%site_url STATIC_URL %}dataview/js/facet.js",
    "{%site_url STATIC_URL %}dataview/js/view.js",
    "{%site_url STATIC_URL %}dataview/js/views/map-view.js",
    "{%site_url STATIC_URL %}dataview/js/views/list-view.js",
    "{%site_url STATIC_URL %}dataview/js/views/openlayers-map-view.js",
    "{%site_url STATIC_URL %}dataview/js/views/scatterplot-view.js",
    "{%site_url STATIC_URL %}dataview/js/views/table-view.js",
    "{%site_url STATIC_URL %}dataview/js/views/timeline-view.js",
    "{%site_url STATIC_URL %}dataview/js/views/piechart-view.js",
    "{%site_url STATIC_URL %}dataview/js/facets/search-facet.js",
    "{%site_url STATIC_URL %}dataview/js/facets/list-facet.js",
    "{%site_url STATIC_URL %}dataview/js/facets/tagcloud-facet.js",
    "{%site_url STATIC_URL %}dataview/js/facets/logo-facet.js",
    "{%site_url STATIC_URL %}dataview/js/lib/creole.js",
    "{%site_url STATIC_URL %}dataview/js/facets/text-facet.js",
    "{%site_url STATIC_URL %}dataview/js/display.js"
{% endblock %}
];
...
FreemixEmbed.includeDependencies = function() {
    ...
    "{% site_url STATIC_URL %}embed/css/embed.css",
...
FreemixEmbed.loadFreemix = function() {
        if (typeof $ != "undefined" && typeof $.freemix != "undefined" && typeof $.freemix.initialize != "undefined" && typeof $.freemix.view != "undefined" && $.freemix.facet != "undefined" && typeof Exhibit != "undefined" && typeof Exhibit.Database != "undefined" && typeof Exhibit.OLMapView != "undefined" && typeof Exhibit.TimelineView != "undefined") {
            $(document).ready(function() {
                ...
                $('#{{where}}').after('<div id="' + randTmpId + '" class="freemix-themeable container_12"><div class="ui-widget-content ui-helper-clearfix"><div class="freemix-themeable"><div id="canvas">{{ canvas|safe }}</div></div></div></div>');
