...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Freemix.file'
        db.delete_column('freemixprofile_freemix', 'file')


    def backwards(self, orm):
        
        # Adding field 'Freemix.file'
        db.add_column('freemixprofile_freemix', 'file', self.gf('django.db.models.fields.files.FileField')(default='dummy', max_length=512), keep_default=False)
