...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Freemix.dataset'
        db.alter_column('freemixprofile_freemix', 'dataset_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['dataset.Dataset']))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'Freemix.dataset'
        raise RuntimeError("Cannot reverse this migration. 'Freemix.dataset' and its values cannot be restored.")
