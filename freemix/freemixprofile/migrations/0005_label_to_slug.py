...
class Migration:
    ...
    def forwards(self, orm):
        ...
        db.rename_column('freemixprofile_freemix', 'label', 'slug')


        # Creating unique_together for [slug, user] on dataprofile.
        db.create_unique('freemixprofile_freemix', ['slug', 'user_id'])
    ...
    def backwards(self, orm):
        ...
        db.delete_unique('freemixprofile_freemix', ['slug', 'user_id'])

        # Rename field 'DataProfile.slug' to 'DataProfile.label'
        db.rename_column('freemixprofile_freemix', 'slug', 'label')
