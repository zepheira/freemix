...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ExhibitTheme'
        db.create_table('freemixprofile_exhibittheme', (
        ...
        db.send_create_signal('freemixprofile', ['ExhibitTheme'])

        # Adding field 'Freemix.title'
        db.add_column('freemixprofile_freemix', 'title', self.gf('django.db.models.fields.CharField')(default='title', max_length=255), keep_default=False)
        ...
        # Changing field 'Freemix.slug'
        db.alter_column('freemixprofile_freemix', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=50))


    def backwards(self, orm):

        # Deleting model 'ExhibitTheme'
        db.delete_table('freemixprofile_exhibittheme')

        # Deleting field 'Freemix.title'
        db.delete_column('freemixprofile_freemix', 'title')

        # Deleting field 'Freemix.new_theme'
        #db.delete_column('freemixprofile_freemix', 'new_theme_id')

        # Changing field 'Freemix.slug'
        db.alter_column('freemixprofile_freemix', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=200))
