...
PermissionsRegistry.register('dataset.can_view', check_published)
PermissionsRegistry.register('dataset.can_edit', check_owner)
PermissionsRegistry.register('dataset.can_delete', check_owner)
PermissionsRegistry.register('datasource.can_view', check_owner)
PermissionsRegistry.register('datasource.can_edit', check_owner)
PermissionsRegistry.register('datasource.can_delete', check_owner)
