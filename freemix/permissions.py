...
class FreemixPermissionsBackend:
    ...
    _registry = {
        ...
        'datasource.can_view': check_owner,
        'datasource.can_edit': check_owner,
        'datasource.can_delete': check_owner,
        'datasourcetransaction.can_view': lambda user_obj, obj: user_obj.id==obj.source.user_id,
    }
